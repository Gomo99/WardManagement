        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConsumableOrders_Employees_CreatedByEmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockTakes_Employees_CreatedByEmployeeId",
                        column: x => x.CreatedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByWardAdminId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Admissions_Employees_CreatedByWardAdminId",
                        column: x => x.CreatedByWardAdminId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScriptManagerId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Employees_PharmacistId",
                        column: x => x.PharmacistId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID");
                    table.ForeignKey(
                        name: "FK_Prescriptions_Employees_ScriptManagerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Admissions_CreatedByWardAdminId",
                table: "Admissions",
                column: "CreatedByWardAdminId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConsumableOrders_CreatedByEmployeeId",
                table: "ConsumableOrders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockTakes_CreatedByEmployeeId",
                table: "StockTakes",
                column: "CreatedByEmployeeId");
